const TheAmericanDreamProjectCoin = artifacts.require("./TheAmericanDreamProjectCoin.sol");
const TheAmericanDreamProjectCoinCrowdsale = artifacts.require("./TheAmericanDreamProjectCoinCrowdsale.sol");
...
module.exports = async function(deployer, network, accounts) {
  ...
  await deployer.deploy(TheAmericanDreamProjectCoin, _name, _symbol, _decimals);
  const deployedToken = await TheAmericanDreamProjectCoin.deployed();
  ...
  await deployer.deploy(
    TheAmericanDreamProjectCoinCrowdsale,
    _rate,
    _wallet,
    _token,
    _cap,
