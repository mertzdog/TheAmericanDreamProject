...
const TheAmericanDreamProjectCoinCrowdsale = artifacts.require('TheAmericanDreamProjectCoinCrowdsale');
const RefundVault = artifacts.require('./RefundVault');
const TokenTimelock = artifacts.require('./TokenTimelock');

contract('TheAmericanDreamProjectCoinCrowdsale', function([_, wallet, investor1, investor2, foundersFund, foundationFund, partnersFund]) {
  ...
  beforeEach(async function () {
    // Token config
    this.name = "TheAmericanDreamProjectCoin";
    this.symbol = "DREAM";
    this.decimals = 18;

    // Deploy Token
    this.token = await TheAmericanDreamProjectCoin.new(
      this.name,
      this.symbol,
      this.decimals
    );
    ...
    this.crowdsale = await TheAmericanDreamProjectCoinCrowdsale.new(
      this.rate,
      this.wallet,
      this.token.address,
      this.cap,
